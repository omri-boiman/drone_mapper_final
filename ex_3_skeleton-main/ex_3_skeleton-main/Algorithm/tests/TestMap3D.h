...
namespace algorithm_211781141_325049575::test {

using namespace common;

// Minimal in-memory IMutableMap3D test double. Algorithm's own tests never
// need NPY loading (that's Simulator's Map3DImpl, not available to this
// project) -- just a settable/queryable bounded voxel grid to exercise
// MappingAlgorithmImpl_211781141_325049575 against, in isolation.
class TestMap3D final : public IMutableMap3D {
public:
    TestMap3D(const types::MappingBounds& bounds, PhysicalLength resolution)
        : config_{bounds, Position3D{}, resolution} {
